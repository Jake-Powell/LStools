...
for(i in 1:length(breakdown)){
  ...
  names(show_table)[3:5] = c('Total students', paste0('Percentage of ', describer ),  paste0('Percentage of ', stage_column))
  if(!do_SDC){
...
# Save workbook
openxlsx::saveWorkbook(wb,  file = paste0(output_dir,'/_',report_name, '_stage_composition.xlsx'), overwrite = TRUE)
```
